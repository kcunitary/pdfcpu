...
[![Test](https://github.com/kcunitary/pdfcpu/workflows/Test/badge.svg)](https://github.com/kcunitary/pdfcpu/actions)
...
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/kcunitary/pdfcpu/releases)
...
* For API examples of all pdfcpu operations please refer to [GoDoc](https://pkg.go.dev/github.com/kcunitary/pdfcpu/pkg/api).

### GoDoc

* [pdfcpu package](https://pkg.go.dev/github.com/pdfcpu/pdfcpu)
* [pdfcpu API](https://pkg.go.dev/github.com/kcunitary/pdfcpu/pkg/api)
* [pdfcpu CLI](https://pkg.go.dev/github.com/kcunitary/pdfcpu/pkg/cli)
...
### Download
Get the latest binary [here](https://github.com/kcunitary/pdfcpu/releases).
...
```
go get github.com/kcunitary/pdfcpu/cmd/...
cd $GOPATH/src/github.com/kcunitary/pdfcpu/cmd/pdfcpu
go install
pdfcpu version
```
